...
abstract class AbstractWindFtp
{
     ...
     *                       </ul>
     * @return bool  配置成功返回true,配置失败返回false
     */
     ...
     * @return bool   重命名成功则返回true,失败则返回false
     */
     ...
     * @return bool   创建文件夹成功则返回true,失败则返回false
     */
     ...
     * @return bool   设置成功则返回true,失败则返回false
     */
     ...
     * @return bool   创建成功返回true创建失败返回false
     */
     ...
     * @return bool   文件存在则返回true,失败则返回false
     */
