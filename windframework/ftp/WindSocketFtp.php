...
class WindSocketFtp extends AbstractWindFtp
{
    ...
    public function download($localfile, $remotefile = '', $mode = 'I')
    {
        ...
        if (!$this->checkcmd()) {
            throw new WindFtpException('[ftp.WindSocketFtp.download] GET', WindFtpException::COMMAND_FAILED);
        }
    ...
    public function fileList($dir = '')
    {
        ...
        if (!$this->checkcmd(true)) {
            throw new WindFtpException('[ftp.WindSocketFtp.fileList] LIST', WindFtpException::COMMAND_FAILED);
        }
    ...
    public function close()
    {
        ...
        if (!$this->sendcmd('QUIT') || !fclose($this->conn)) {
            throw new WindFtpException('[ftp.WindSocketFtp.fileList] QUIT', WindFtpException::COMMAND_FAILED);
        }
