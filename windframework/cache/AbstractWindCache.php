...
abstract class AbstractWindCache extends WindModule
{
     ...
     * @return bool
     */
    abstract protected function setValue($key, $value, $expires = 0);
     ...
     * @return bool
     */
    abstract protected function addValue($key, $value, $expires = 0);
